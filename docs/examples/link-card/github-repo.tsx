...
export default function GithubRepoCard() {
	return (
		<LinkCardShell href="https://github.com/vercel/next.js">
			...
			<div className="space-y-2 p-3">
				...
				<p className="line-clamp-2 text-sm text-tertiary">
					The React Framework for the Web. Built on React 19 with support for
					Server Components, Actions, and more.
				</p>
				<div className="flex flex-wrap gap-1">
					{["react", "nextjs", "javascript", "ssr"].map((t) => (
						<span
							key={t}
				...
				<div className="flex items-center gap-3 text-sm text-tertiary">
					<span className="flex items-center gap-1">
						<span
							aria-hidden
							className="inline-block size-2 rounded-full bg-yellow-300"
						/>
						TypeScript
					</span>
					<span>★ 131k</span>
