  ...
  const pickTarget = (
    ...
    >
      <div
        className={
          dragOver
            ? "group ring-focus rounded-full p-1 ring-2"
      ...
      >
        <button
          ...
          className="relative block cursor-pointer rounded-full focus-visible:ring-2 focus-visible:ring-focus focus-visible:ring-offset-2 focus-visible:ring-offset-base-1"
        >
          <Avatar
            initial={initial}
            src={currentUrl}
          ...
          <span
            className={
              dragOver || uploading
                ? "absolute inset-0 z-1 flex items-center justify-center opacity-100 scale-100 transition-[opacity,scale] duration-100 ease-out"
                : "absolute inset-0 z-1 flex items-center justify-center invisible opacity-0 scale-95 transition-[opacity,scale] duration-100 ease-out group-hover:visible group-hover:opacity-100 group-hover:scale-100"
            }
          >
      ...
      {currentUrl && (
        <Button
          ...
          className={
            uploading
              ? "absolute right-0 bottom-0 rounded-full text-danger p-1 opacity-0 pointer-events-none"
              : "absolute right-0 bottom-0 rounded-full text-danger p-1 hover:bg-base-2"
          }
