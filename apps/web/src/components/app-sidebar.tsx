...
const navItems: SidebarNavItem[] = [
	{ to: "/", label: "Home", icon: HomeIcon, iconActive: HomeIconSolid, end: true },
	...
	{ to: "/inbox", label: "Messages", icon: EnvelopeIcon, iconActive: EnvelopeIconSolid },
	{ to: "/analytics", label: "Analytics", icon: ChartBarIcon, iconActive: ChartBarIconSolid },
	{ to: "/bookmarks", label: "Bookmarks", icon: BookmarkIcon, iconActive: BookmarkIconSolid },
	{ to: "/lists", label: "Lists", icon: ListBulletIcon, iconActive: ListBulletIconSolid },
	{ to: "/drafts", label: "Drafts", icon: ClockIcon, iconActive: ClockIconSolid },
]
