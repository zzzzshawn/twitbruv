...
export function Hover({
	...
	return (
		<div
			className={cn(
				"group/h relative flex items-center text-primary text-sm",
		...
		>
			<div
				className={cn(
					...
					focus &&
						!disabled &&
						"group-has-focus-visible/h:inset-0 group-has-focus-visible/h:opacity-100 group-has-focus-visible/h:ring-focus group-has-focus-visible/h:ring-2 group-has-focus-visible/h:ring-offset-2",
				)}
			/>
...
function HoverGrouped({
	...
	return (
		<div
			...
			className={cn(
				"group/hi relative z-[1] flex items-center text-primary text-sm",
				fullWidth ? "w-full" : "w-fit",
				className,
			)}
		>
