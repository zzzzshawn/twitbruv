...
const inputStyles = [
  ...
  "focus-visible:ring-2 focus-visible:border-neutral-strong focus-visible:ring-focus/30",
...
const wrapperStyles = [
  ...
  "transition-[box-shadow,color,border-color,background-color] duration-150 ease-out-expo",
  "has-[:focus-visible]:ring-2 has-[:focus-visible]:border-neutral-strong has-[:focus-visible]:ring-focus/30",
  "motion-reduce:transition-none",
